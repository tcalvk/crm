...
<main class="mt-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Create Contact for <?php echo htmlspecialchars($customer_info['Name']); ?></h4>
        <a href="index.php?action=customer_contacts&customer_id=<?php echo $customer_id; ?>">Back to Contacts</a>
    </div>
    ...
    <form method="post" action="index.php">
        <input type="hidden" name="action" value="store_contact">
